...
assert.equal(expo.ios?.buildNumber, '6');
...
console.log(
  'config_ok name=GearDrop bundle=dev.100app.geardrop buildNumber=6 usesNonExemptEncryption=false privacyUrl=https://001.100app.dev/privacy.html plugins=' +
    [...pluginNames].join(','),
);
